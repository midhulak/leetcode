	...
	public class CourseScheduleOne {
	    ...
	    public static boolean canFinish(int n, int[][] a) {
	        ...
	        for(int k : g.keySet()) {
	            int c = helper(n, k, g, visited, new HashSet(), stack );
	            if(c == -1) {
	                return false;
	            }
	    ...
	    public static int helper(int n, int k, Map<Integer, List<Integer>> g,
	                       Set<Integer> visited, Set<Integer> visiting , Stack<Integer> stack) {
	        ...
	        if(g.containsKey(k)) {
	            ...
	            for(int i : cs) {
	                ...
	                int t = helper(n, i, g, visited, visiting , stack);
	                if(t < 0) {
	                    return -1;
	                }
	                count += t;
	        ...
	        visited.add(k);
	      // stack.push(k);
	     System.out.println("visited in order="+k);
	        return count;
	    }

	    public static void main(String[] args) {
	        int[][] test_input_1 = {};
	         canFinish(2, test_input_1);
