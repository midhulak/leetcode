...
class TopologicalSortofAllPossiblePaths { 
    int V; // No. of vertices 
  
    List<Integer> adjListArray[]; 
  
    public TopologicalSortofAllPossiblePaths(int V) { 
    ...
    public static void main(String[] args) { 
    	...
    	TopologicalSortofAllPossiblePaths graph = new TopologicalSortofAllPossiblePaths(6); 
